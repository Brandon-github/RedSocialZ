...
const t1 = window.ShadowRoot && (window.ShadyCSS === void 0 || window.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, e = Symbol(), n = new Map();
class s {
    constructor(t2, n2){
        if (this._$cssResult$ = true, n2 !== e) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
        this.cssText = t2;
    }
    get styleSheet() {
        let e2 = n.get(this.cssText);
        return t1 && e2 === void 0 && (n.set(this.cssText, e2 = new CSSStyleSheet()), e2.replaceSync(this.cssText)), e2;
    }
    toString() {
        return this.cssText;
    }
...
, r = (t2, ...n2)=>{
    ...
    t1 ? e2.adoptedStyleSheets = n2.map((t2)=>t2 instanceof CSSStyleSheet ? t2 : t2.styleSheet
    ) : n2.forEach((t2)=>{
...
class a extends HTMLElement {
    ...
    o() {
        ...
        ), this._$AL = new Map(), this._$Em(), this.requestUpdate(), (t = this.constructor.l) === null || t === void 0 || t.forEach((t2)=>t2(this)
        );
    }
    addController(t) {
        var i2, s2;
    ...
    _$AK(t, i2) {
        ...
        if (n2 !== void 0 && this._$Ei !== n2) {
            const t2 = h2.getPropertyOptions(n2), l2 = t2.converter, a3 = (r2 = (e2 = (s2 = l2) === null || s2 === void 0 ? void 0 : s2.fromAttribute) !== null && e2 !== void 0 ? e2 : typeof l2 == "function" ? l2 : null) !== null && r2 !== void 0 ? r2 : o1.fromAttribute;
            this._$Ei = n2, this[n2] = a3(i2, t2.type), this._$Ei = null;
        }
    }
    requestUpdate(t, i2, s2) {
        let e2 = true;
        t !== void 0 && (((s2 = s2 || this.constructor.getPropertyOptions(t)).hasChanged || n1)(this[t], i2) ? (this._$AL.has(t) || this._$AL.set(t, i2), s2.reflect === true && this._$Ei !== t && (this._$E_ === void 0 && (this._$E_ = new Map()), this._$E_.set(t, s2))) : e2 = false), !this.isUpdatePending && e2 && (this._$Ep = this._$EC());
    }
    async _$EC() {
    ...
    performUpdate() {
        ...
        this.hasUpdated, this._$Et && (this._$Et.forEach((t2, i3)=>this[i3] = t2
        ), this._$Et = void 0);
        let i2 = false;
        const s2 = this._$AL;
        try {
    ...
    update(t) {
        this._$E_ !== void 0 && (this._$E_.forEach((t2, i2)=>this._$ES(i2, this[i2], t2)
...
a.finalized = true, a.elementProperties = new Map(), a.elementStyles = [], a.shadowRootOptions = {
    ...
    ReactiveElement: a
}), ((s1 = globalThis.reactiveElementVersions) !== null && s1 !== void 0 ? s1 : globalThis.reactiveElementVersions = []).push("1.0.2");
var t3;
const i1 = globalThis.trustedTypes, s2 = i1 ? i1.createPolicy("lit-html", {
    createHTML: (t2)=>t2
}) : void 0, e2 = `lit$${(Math.random() + "").slice(9)}$`, o2 = "?" + e2, n3 = `<${o2}>`, l1 = document, h1 = (t2 = "")=>l1.createComment(t2)
, r2 = (t2)=>t2 === null || typeof t2 != "object" && typeof t2 != "function"
, d = Array.isArray, u = (t2)=>{
    var i2;
    return d(t2) || typeof ((i2 = t2) === null || i2 === void 0 ? void 0 : i2[Symbol.iterator]) == "function";
}, c = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, v = /-->/g, a1 = />/g, f = />|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g, _ = /'/g, m = /"/g, g = /^(?:script|style|textarea)$/i, $ = (t2)=>(i2, ...s2)=>({
            _$litType$: t2,
            strings: i2,
            values: s2
        })
, p = $(1), b = Symbol.for("lit-noChange"), T = Symbol.for("lit-nothing"), x = new WeakMap(), w = (t2, i2, s2)=>{
    var e2, o2;
...
}, A = l1.createTreeWalker(l1, 129, null, false), C = (t2, i2)=>{
    const o2 = t2.length - 1, l2 = [];
    let h2, r2 = i2 === 2 ? "<svg>" : "", d2 = c;
    for(let i3 = 0; i3 < o2; i3++){
        const s2 = t2[i3];
        let o3, u3, $2 = -1, p2 = 0;
        for(; p2 < s2.length && (d2.lastIndex = p2, u3 = d2.exec(s2), u3 !== null);)p2 = d2.lastIndex, d2 === c ? u3[1] === "!--" ? d2 = v : u3[1] !== void 0 ? d2 = a1 : u3[2] !== void 0 ? (g.test(u3[2]) && (h2 = RegExp("</" + u3[2], "g")), d2 = f) : u3[3] !== void 0 && (d2 = f) : d2 === f ? u3[0] === ">" ? (d2 = h2 != null ? h2 : c, $2 = -1) : u3[1] === void 0 ? $2 = -2 : ($2 = d2.lastIndex - u3[2].length, o3 = u3[1], d2 = u3[3] === void 0 ? f : u3[3] === '"' ? m : _) : d2 === m || d2 === _ ? d2 = f : d2 === v || d2 === a1 ? d2 = c : (d2 = f, h2 = void 0);
        const y2 = d2 === f && t2[i3 + 1].startsWith("/>") ? " " : "";
        r2 += d2 === c ? s2 + n3 : $2 >= 0 ? (l2.push(o3), s2.slice(0, $2) + "$lit$" + s2.slice($2) + e2 + y2) : s2 + e2 + ($2 === -2 ? (l2.push(void 0), i3) : y2);
    }
...
class P {
    constructor({ strings: t21 , _$litType$: s2  }, n21){
        let l2;
        this.parts = [];
        let r2 = 0, d2 = 0;
        const u2 = t21.length - 1, c2 = this.parts, [v2, a2] = C(t21, s2);
        if (this.el = P.createElement(v2, n21), A.currentNode = this.el.content, s2 === 2) {
        ...
        for(; (l2 = A.nextNode()) !== null && c2.length < u2;){
            if (l2.nodeType === 1) {
                if (l2.hasAttributes()) {
                    const t3 = [];
                    for (const i2 of l2.getAttributeNames())if (i2.endsWith("$lit$") || i2.startsWith(e2)) {
                        const s3 = a2[d2++];
                ...
                if (g.test(l2.tagName)) {
                    ...
                    if (s3 > 0) {
                        ...
                        for(let i2 = 0; i2 < s3; i2++)l2.append(t3[i2], h1()), A.nextNode(), c2.push({
                            type: 2,
                            index: ++r2
                        });
                        l2.append(t3[s3], h1());
                ...
                let t3 = -1;
                for(; (t3 = l2.data.indexOf(e2, t3 + 1)) !== -1;)c2.push({
                    type: 7,
                    index: r2
                }), t3 += e2.length - 1;
            }
...
class E {
    constructor(t22, i21){
        this.v = [], this._$AN = void 0, this._$AD = t22, this._$AM = i21;
    }
    get parentNode() {
...
class N {
    constructor(t23, i22, s21, e2){
        var o2;
        this.type = 2, this._$AH = T, this._$AN = void 0, this._$AA = t23, this._$AB = i22, this._$AM = s21, this.options = e2, this._$Cg = (o2 = e2 == null ? void 0 : e2.isConnected) === null || o2 === void 0 || o2;
    }
    get _$AU() {
        var t2, i2;
    ...
    _$AI(t2, i2 = this) {
        t2 = V(this, t2, i2), r2(t2) ? t2 === T || t2 == null || t2 === "" ? (this._$AH !== T && this._$AR(), this._$AH = T) : t2 !== this._$AH && t2 !== b && this.$(t2) : t2._$litType$ !== void 0 ? this.T(t2) : t2.nodeType !== void 0 ? this.S(t2) : u(t2) ? this.M(t2) : this.$(t2);
    }
    A(t2, i2 = this._$AB) {
    ...
    $(t2) {
        this._$AH !== T && r2(this._$AH) ? this._$AA.nextSibling.data = t2 : this.S(l1.createTextNode(t2)), this._$AH = t2;
    }
    T(t2) {
        var i2;
    ...
    M(t2) {
        ...
        const i2 = this._$AH;
        let s2, e2 = 0;
        for (const o2 of t2)e2 === i2.length ? i2.push(s2 = new N(this.A(h1()), this.A(h1()), this, this.options)) : s2 = i2[e2], s2._$AI(o2), e2++;
...
class S1 {
    constructor(t24, i23, s22, e21, o21){
        this.type = 1, this._$AH = T, this._$AN = void 0, this.element = t24, this.name = i23, this._$AM = e21, this.options = o21, s22.length > 2 || s22[0] !== "" || s22[1] !== "" ? (this._$AH = Array(s22.length - 1).fill(new String()), this.strings = s22) : this._$AH = T;
    }
    get tagName() {
    ...
    _$AI(t2, i2 = this, s2, e2) {
        ...
        let n2 = false;
        if (o2 === void 0) t2 = V(this, t2, i2, 0), n2 = !r2(t2) || t2 !== this._$AH && t2 !== b, n2 && (this._$AH = t2);
        else {
            const e3 = t2;
            let l2, h2;
            for(t2 = o2[0], l2 = 0; l2 < o2.length - 1; l2++)h2 = V(this, e3[s2 + l2], i2, l2), h2 === b && (h2 = this._$AH[l2]), n2 || (n2 = !r2(h2) || h2 !== this._$AH[l2]), h2 === T ? t2 = T : t2 !== T && (t2 += (h2 != null ? h2 : "") + o2[l2 + 1]), this._$AH[l2] = h2;
        }
        n2 && !e2 && this.k(t2);
    }
    k(t2) {
...
class I extends S1 {
    constructor(t25, i24, s23, e22, o22){
        super(t25, i24, s23, e22, o22), this.type = 5;
    }
    _$AI(t2, i2 = this) {
        var s2;
        if ((t2 = (s2 = V(this, t2, i2, 0)) !== null && s2 !== void 0 ? s2 : T) === b) return;
...
class L {
    constructor(t26, i25, s24){
        this.element = t26, this.type = 6, this._$AN = void 0, this._$AM = i25, this.options = s24;
    }
    get _$AU() {
        return this._$AM._$AU;
    }
...
s3.finalized = true, s3._$litElement$ = true, (l3 = globalThis.litElementHydrateSupport) === null || l3 === void 0 || l3.call(globalThis, {
    LitElement: s3
});
const n4 = globalThis.litElementPolyfillSupport;
n4 == null || n4({
    LitElement: s3
});
((o3 = globalThis.litElementVersions) !== null && o3 !== void 0 ? o3 : globalThis.litElementVersions = []).push("3.0.2");
class FollowButton extends s3 {
